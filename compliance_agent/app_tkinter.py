...
class ComplianceAgentApp:
    ...
    def create_widgets(self):
        ...
        input_frame = tk.Frame(main_frame, bg="#ffffff", relief="ridge", bd=2)
        input_frame.pack(fill="x", pady=(0, 15))
        
        video_frame = tk.Frame(input_frame, bg="#ffffff")
        video_frame.pack(fill="x", pady=(10, 5), padx=10)
        ...
        self.video_path_label = tk.Label(video_frame, text="未选择文件", bg="#ffffff", fg="#888888")
        ...
        report_frame = tk.Frame(input_frame, bg="#ffffff")
        report_frame.pack(fill="x", pady=(5, 10), padx=10)
        ...
        self.report_path_label = tk.Label(report_frame, text="未选择文件", bg="#ffffff", fg="#888888")
        ...
        text_frame = tk.Frame(main_frame, bg="#ffffff", relief="ridge", bd=2)
        ...
        transcribe_frame = tk.Frame(main_frame, bg="#ffffff", relief="ridge", bd=2)
        ...
        self.transcribe_text = scrolledtext.ScrolledText(
            transcribe_frame, 
            height=6,
            font=("Microsoft YaHei", 11),
            bg="#f8f9fa",
        ...
        self.transcribe_text.pack(fill="both", expand=True, padx=10, pady=(0, 10))
        ...
        tk.Button(
            ...
            font=("Microsoft YaHei", 11),
            relief="flat"
        ).pack(side="right", padx=(10, 0), pady=15)
        ...
        result_frame = tk.Frame(main_frame, bg="#ffffff", relief="ridge", bd=2)
        ...
        self.progress_bar = tk.Canvas(self.progress_frame, height=20, bg="#e0e0e0", highlightthickness=0)
    ...
    def select_video(self):
        ...
        try:
            ...
            self.video_path_label.configure(text=resolved_path.name, fg="#333333")
    ...
    def select_report(self):
        ...
        if file_path:
            ...
            self.report_path_label.configure(text=Path(file_path).name, fg="#333333")
    ...
    def run_check(self, note_text):
        try:
            self.root.after(100, lambda: self.update_progress(0.2))
            
            if self.video_path:
                self.root.after(100, lambda: self.update_progress(0.3))
            ...
            self.root.after(100, lambda: self.update_progress(0.4))
            ...
            self.root.after(100, lambda: self.update_progress(0.6))
            
            compliance_result = self.compliance_checker.check_compliance(result)
            
            self.root.after(100, lambda: self.update_progress(0.8))
            ...
            self.root.after(100, lambda: self.update_progress(1.0))
    ...
    def clear_all(self):
        ...
        self.video_path_label.configure(text="未选择文件", fg="#888888")
        self.report_path_label.configure(text="未选择文件", fg="#888888")
